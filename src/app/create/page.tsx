...
const infoItems = [
    {
        ...
        description: "It is the fundamental standard for creating fungible tokens (coins) on the Solana network. Ideal for most projects that require a simple and efficient token."
    },
    {
