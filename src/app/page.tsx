...
// Ícones como componentes SVG para evitar requisições de rede adicionais
        ...
        <div className="featuresGrid">
          <div className="featureCard">
           ...
           <div className="featureCard">
            ...
            <p>Crie um pool de liquidez CPMM moderno e eficiente na Raydium, sem a necessidade de criar um OpenBook Market ID. Mais rápido e mais barato.</p>
          </div>
          <div className="featureCard">
